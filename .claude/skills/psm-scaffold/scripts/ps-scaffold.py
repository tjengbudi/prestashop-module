...
def main():
    ...
    ap.add_argument("--ps-min", default="1.7.0.0", help="Versi PrestaShop minimum (default 1.7.0.0)")
    ap.add_argument("--ps-max", default="9.99.99", help="Versi PrestaShop maksimum (default 9.99.99)")
